    ...
    public partial class initdatabase : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AccountsData", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AccountsData_UserRoles_RoleId",
                        column: x => x.RoleId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccountDataId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Authors", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Authors_AccountsData_AccountDataId",
                        column: x => x.AccountDataId,
                        principalTable: "AccountsData",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Publishers_AccountsData_AccountDataId",
                        column: x => x.AccountDataId,
                        principalTable: "AccountsData",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Users_AccountsData_AccountDataId",
                        column: x => x.AccountDataId,
                        principalTable: "AccountsData",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccountsData_RoleId",
                table: "AccountsData",
                column: "RoleId");

            migrationBuilder.CreateIndex(
                name: "IX_Authors_AccountDataId",
                table: "Authors",
                column: "AccountDataId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Publishers_AccountDataId",
                table: "Publishers",
                column: "AccountDataId",
                unique: true);
